...
class ArticleCreateViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        if section == 0 {
            ...
            return shouldDisplayAllCategories ? categories.count : 1
        } else if section == 2 {
            return shouldDisplayAllColors ? colors.count : 1
        } else if section == 3 {
            return shouldDisplayAllTextures ? textures.count : 1
        }
        return 0
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if indexPath.section == 0 {
            ...
            if indexPath.row == 0 {
                ...
                text = categories[indexPath.row-1]
            }
